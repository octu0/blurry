#ifndef HALIDE__librotate0_osx_h
#define HALIDE__librotate0_osx_h
#include <stdint.h>
...
int rotate0_par_for_rotate0_s0_ch(void *__user_context, int32_t _rotate0_s0_ch, uint8_t *_closure_arg__50);
HALIDE_FUNCTION_ATTRS
