...
int canny(struct halide_buffer_t *_p14_buffer, int32_t _width, int32_t _height, int32_t _threshold_max, int32_t _threshold_min, uint8_t _morphology_mode, int32_t _morphology_size, int32_t _dilate, struct halide_buffer_t *_canny_buffer);
