...
int canny(struct halide_buffer_t *_p13_buffer, int32_t _width, int32_t _height, int32_t _threshold_max, int32_t _threshold_min, float _sigma, struct halide_buffer_t *_canny_buffer);
