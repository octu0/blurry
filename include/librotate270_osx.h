#ifndef HALIDE__librotate270_osx_h
#define HALIDE__librotate270_osx_h
#include <stdint.h>
...
int rotate270(struct halide_buffer_t *_p4_buffer, int32_t _width, int32_t _height, struct halide_buffer_t *_rotate270_buffer);
