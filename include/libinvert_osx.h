...
HALIDE_FUNCTION_ATTRS
int invert_par_for_invert_s0_ch_par_for_invert_s0_x_xo_ti_ti(void *__user_context, int32_t _invert_s0_x_xo_ti_ti, uint8_t *_closure_arg__130);
HALIDE_FUNCTION_ATTRS
int invert_par_for_invert_s0_ch_par_for_invert_s0_x_xo_ti_ti__1(void *__user_context, int32_t _invert_s0_x_xo_ti_ti, uint8_t *_closure_arg__131);
HALIDE_FUNCTION_ATTRS
