...
int prepare_zncc_template_par_for_prepare_zncc_template_s0_x_xo_ti__1(void *__user_context, int32_t _prepare_zncc_template_s0_x_xo_ti, uint8_t *_closure_arg__318);
HALIDE_FUNCTION_ATTRS
