...
int canny_morphology_close_par_for_dilate_tmp_6_s0_y_y__1(void *__user_context, int32_t _dilate_tmp__6_s0_y_y, uint8_t *_closure_arg__272);
HALIDE_FUNCTION_ATTRS
int canny_morphology_close_par_for_erode_tmp_3_s0_y_y__5(void *__user_context, int32_t _erode_tmp__3_s0_y_y, uint8_t *_closure_arg__273);
HALIDE_FUNCTION_ATTRS
int canny_morphology_close_par_for_hysteresis_3_s0_x_xo_ti__1(void *__user_context, int32_t _hysteresis__3_s0_x_xo_ti, uint8_t *_closure_arg__274);
HALIDE_FUNCTION_ATTRS
int canny_morphology_close_par_for_canny_morphology_close_s0_ch__1(void *__user_context, int32_t _canny_morphology_close_s0_ch, uint8_t *_closure_arg__275);
HALIDE_FUNCTION_ATTRS
