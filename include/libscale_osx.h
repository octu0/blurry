...
int scale_par_for_scale_s0_ch_par_for_scale_s0_x_xo_ti(void *__user_context, int32_t _scale_s0_x_xo_ti, uint8_t *_closure_arg__67);
HALIDE_FUNCTION_ATTRS
int scale_par_for_scale_s0_ch_par_for_scale_s0_x_xo_ti__1(void *__user_context, int32_t _scale_s0_x_xo_ti, uint8_t *_closure_arg__68);
HALIDE_FUNCTION_ATTRS
int scale_par_for_scale_s0_ch(void *__user_context, int32_t _scale_s0_ch, uint8_t *_closure_arg__66);
HALIDE_FUNCTION_ATTRS
