...
int prepare_ncc_template_par_for_prepare_ncc_template_s0_x_xo_ti__7(void *__user_context, int32_t _prepare_ncc_template_s0_x_xo_ti, uint8_t *_closure_arg__288);
HALIDE_FUNCTION_ATTRS
