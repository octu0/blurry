#ifndef HALIDE__libboxblur_osx_h
#define HALIDE__libboxblur_osx_h
#include <stdint.h>
...
int boxblur(struct halide_buffer_t *_p15_buffer, int32_t _width, int32_t _height, uint8_t _size, struct halide_buffer_t *_boxblur_buffer);
