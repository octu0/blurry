...
int prepared_match_template_ncc_par_for_prepared_match_template_ncc_s0_x_xo_ti__2(void *__user_context, int32_t _prepared_match_template_ncc_s0_x_xo_ti, uint8_t *_closure_arg__316);
HALIDE_FUNCTION_ATTRS
