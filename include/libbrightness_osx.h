#ifndef HALIDE__libbrightness_osx_h
#define HALIDE__libbrightness_osx_h
#include <stdint.h>
...
int brightness(struct halide_buffer_t *_p12_buffer, int32_t _width, int32_t _height, float _factor, struct halide_buffer_t *_brightness_buffer);
