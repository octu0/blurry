...
int contour_par_for_sobel_5_s0_x_xo_ti_ti__1(void *__user_context, int32_t _sobel__5_s0_x_xo_ti_ti, uint8_t *_closure_arg__327);
HALIDE_FUNCTION_ATTRS
int contour_par_for_countor_line_s0_x_xo_ti__1(void *__user_context, int32_t _countor_line_s0_x_xo_ti, uint8_t *_closure_arg__328);
HALIDE_FUNCTION_ATTRS
