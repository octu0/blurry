#ifndef HALIDE__libblend_sub_linux_h
#define HALIDE__libblend_sub_linux_h
#include <stdint.h>
...
HALIDE_FUNCTION_ATTRS
int blend_sub_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *blend_sub_metadata();
