...
int canny_par_for_in_39_s0_y_rebased__3(void *__user_context, int32_t _in__39_s0_y_rebased, uint8_t *_closure_arg__254);
HALIDE_FUNCTION_ATTRS
int canny_par_for_hysteresis_s0_x_xo_ti(void *__user_context, int32_t _hysteresis_s0_x_xo_ti, uint8_t *_closure_arg__255);
HALIDE_FUNCTION_ATTRS
int canny_par_for_canny_s0_ch(void *__user_context, int32_t _canny_s0_ch, uint8_t *_closure_arg__256);
HALIDE_FUNCTION_ATTRS
