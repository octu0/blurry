#ifndef HALIDE__libflipH_osx_h
#define HALIDE__libflipH_osx_h
#include <stdint.h>
...
int flipH_par_for_flipH_s0_ch(void *__user_context, int32_t _flipH_s0_ch, uint8_t *_closure_arg__60);
HALIDE_FUNCTION_ATTRS
int flipH(struct halide_buffer_t *_src_buffer, int32_t _width, int32_t _height, struct halide_buffer_t *_flipH_buffer);

HALIDE_FUNCTION_ATTRS
int flipH_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *flipH_metadata();
